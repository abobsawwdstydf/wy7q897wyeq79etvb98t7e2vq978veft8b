...
export default function LocationModal({ onClose, onSend }: LocationModalProps) {
  ...
  return (
    ...
    <div
      className="fixed inset-0 z-[200] bg-black/80 flex items-end sm:items-center justify-center"
    ...
    >
      <motion.div
        ...
        className="w-full max-w-sm bg-[#0f0f14] rounded-t-2xl sm:rounded-2xl border-t sm:border border-white/10 shadow-2xl overflow-hidden"
