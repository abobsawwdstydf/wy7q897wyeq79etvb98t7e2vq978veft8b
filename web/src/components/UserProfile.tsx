        ...
        <div className="mx-4 mb-3 rounded-2xl bg-white/[0.04] border border-white/[0.06]">
          ...
          {profile.birthday && (
            <div className="w-full flex items-start gap-3.5 px-4 py-[11px] border-b border-white/[0.06]">
              ...
              <div className="min-w-0">
                <p className="text-[13px] text-zinc-500 leading-tight">{t('birthday')}</p>
          ...
          <>
            ...
            >
              ...
              <div className="p-4 space-y-4 max-h-[70vh] overflow-y-auto">
                ...
                <div>
                  <label className="text-[13px] text-zinc-500 mb-2 block">Дата рождения</label>
                  <DatePicker value={editData.birthday} onChange={(val) => setEditData({ ...editData, birthday: val })} />
                </div>
              </div>
