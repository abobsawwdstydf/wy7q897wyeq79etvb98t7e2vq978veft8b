  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        ...
        globPatterns: ['**/*.{js,css,html,ico,png,svg,woff2,webp,avif,gif}'],
        ...
        runtimeCaching: [
          ...
          {
            urlPattern: /^\/stickers\/.+\.(gif|webp|png|jpg|svg)$/i,
            handler: 'CacheFirst',
            options: {
          ...
          {
            urlPattern: /^\/animated-emojis\/.+\.gif$/i,
            handler: 'CacheFirst',
            options: {
              cacheName: 'animated-emojis-cache',
              expiration: {
                maxEntries: 1000,
                maxAgeSeconds: 60 * 60 * 24 * 365
              },
          ...
          {
            urlPattern: /\.(png|svg|webp|avif|jpg|jpeg|gif)$/i,
          ...
          {
            urlPattern: /\/api\/stickers\/.*/i,
            handler: 'CacheFirst',
            options: {
              cacheName: 'stickers-api-cache',
              expiration: {
                maxEntries: 200,
                maxAgeSeconds: 60 * 60 * 24 * 30
              },
